...
#5. Provide IntervalMinutes for cycle time.
...
IntervalMinutes = 17                           #Time interval in minutes between cycles
...
#Main process:  Run vacation lights cycle every IntervalMinutes
while True:
    try:
